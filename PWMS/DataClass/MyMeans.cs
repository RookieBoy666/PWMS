...
namespace PWMS.DataClass
{
    ...
    class MyMeans
    {
        ...
        public static string M_str_sqlcon = "Data Source=.;Database=db_PWMS;User id=sa;PWD=123456";
        //public static string M_str_sqlcon = @"Data Source=XIAOKE;Initial Catalog=db_PWMS;Integrated Security=True";
